...
print('total number of distinct words: ' + str(dCount_letters))
print('popular_threshold_word: ' + str(popular_letters))
print('common_threshold_l_word: ' + str(common_l_letters))
print('common_threshold_u_word: ' + str(common_u_letters))
print('rare_threshold_word: ' + str(rare_letters))
